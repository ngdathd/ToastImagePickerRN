...
import csell.com.ngdat.library.imagepicker.features.camera.CameraHelper;
import csell.com.ngdat.library.imagepicker.features.camera.DefaultCameraModule;
...
import csell.com.ngdat.library.imagepicker.features.recyclers.RecyclerViewManager;
import csell.com.ngdat.library.imagepicker.helper.ConfigUtils;
import csell.com.ngdat.library.imagepicker.helper.ImagePickerPreferences;
import csell.com.ngdat.library.imagepicker.helper.IpCrasher;
...
import csell.com.ngdat.library.imagepicker.view.SnackBarView;

import static android.app.Activity.RESULT_CANCELED;
import static android.app.Activity.RESULT_OK;
import static csell.com.ngdat.library.imagepicker.helper.ImagePickerPreferences.PREF_WRITE_EXTERNAL_STORAGE_REQUESTED;
...
public class ImagePickerFragment extends Fragment implements ImagePickerView {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (isCameraOnly) {
            ...
            View result = localInflater.inflate(R.layout.fragment_image_picker, container, false);
            setupView(result);
            if (savedInstanceState == null) {
    ...
    private void requestWriteExternalPermission() {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(getActivity(), Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            ...
            if (!preferences.isPermissionRequested(permission)) {
                ...
                snackBarView.show(R.string.msg_no_write_external_permission, v -> openAppSettings());
            }
        }
    }
        ...
        if (checkForRationale(permissions)) {
            ...
            if (!preferences.isPermissionRequested(permission)) {
                ...
                if (isCameraOnly) {
                    ...
                    snackBarView.show(R.string.msg_no_camera_permission, v -> openAppSettings());
                }
            }
        }
    }
